// API Configuration
const API_URL = 'https://script.google.com/macros/s/AKfycbwotX355N3xGG_glNVGZh-yYvgddgprPYD-UT1ILeOYWn4zpzJN--3jhDjaPkn8VbqccA/exec';
  ...
  try {
    ...
    if (allMembers.length === 0) {
      ...
      allMembers.forEach(member => {
        ...
        const isTargetAdmin = member.isAdmin || (memberPos.toLowerCase() === 'admin') || (memberPos.toLowerCase() === 'super admin');
