// API Configuration
const API_URL = 'https://script.google.com/macros/s/AKfycbxQFyo5Q5H2CsWlyAiGcu2vKPzNJfBvV9BwvxQn7DbHeAt8DwARr-83mY-EZwEqhmSp/exec';
...
function downloadReport() {
  ...
  // Use direct Google Sheets export URL
  const spreadsheetId = '1Pk1cRDD36GGiG2r2grL8wp7oLjMUBF77SmBFpdFlIB0';
  const downloadUrl = `https://docs.google.com/spreadsheets/d/${spreadsheetId}/export?format=xlsx`;
  
  // Open in new tab to trigger download
  window.open(downloadUrl, '_blank');
  
  showNotification('Download started! (Full spreadsheet)', 'success');
}
